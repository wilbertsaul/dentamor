<x-guest-layout>
    <div class="flex items-center gap-2 mb-6">
        ...
        <h2 class="text-headline-sm font-bold text-on-surface">Crear cuenta</h2>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Nombre completo" />
